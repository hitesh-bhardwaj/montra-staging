...
const personalFinance = () => {
 ...
 <InvestmentPlans/>
   <SectionBreak content={"Whether you're borrowing, insuring, or investing, our app brings everything together in one seamless experience."} width={"w-[85%]"}/>
...
const benefitsData ={
  heading:"Compare <span class='text-primary'>Loan </span> Offers. Get Funded Instantly.",
  ...
  paraWidth:"w-[45%]",
  cards:[
  {  classPrefix: "a" ,left:"!left-[10%]",top:"!top-[25%]",color:"bg-[#EAF1FF]", content:"Stay updated in real-time. Monitor the progress of your loan applications right from your Montra app.",title:"Compare Loan Offers" ,z:"z-[6]", width:"w-[21vw]", height:"17vw" },
  { classPrefix: "b" ,left:"!left-[20%]",top:"!top-[55%]",color:"bg-[#FEFFA7]", content:"Stay updated in real-time. Monitor the progress of your loan applications right from your Montra app.",title:"View Loan Statements" ,z:"z-[5]", width:"w-[22vw]", height:"17vw"},
  {  classPrefix: "c",left:"!left-[45.5%]",top:"!top-[15%]",color:"bg-[#FFEAEE]",content:"Stay updated in real-time. Monitor the progress of your loan applications right from your Montra app.",title:"Track Your Application" ,z:"z-[7]", width:"w-[22vw]", height:"17vw"},
  {  classPrefix: "d" ,left:"!left-[70%]",top:"!top-[45.9%]",color:"bg-[#D9F7C5]", content:"Stay updated in real-time. Monitor the progress of your loan applications right from your Montra app.",title:"Easy Repayments",z:"z-[6]", width:"w-[18vw]", height:"17vw"},
  {  classPrefix: "e" ,left:"!left-[60%]",top:"!top-[80%]",color:"bg-[#FFD7CB]", content:"Stay updated in real-time. Monitor the progress of your loan applications right from your Montra app.",title:"Smart Payment Reminders" ,z:"z-[4]", width:"w-[24vw]", height:"17vw" },
  {  classPrefix: "f" ,left:"!left-[10%]",top:"!top-[85%]",color:"bg-[#CAC5F7]", content:"Stay updated in real-time. Monitor the progress of your loan applications right from your Montra app.",title:"Instant Disbursement" ,z:"z-[4]",width:"w-[21vw]", height:"17vw" }
  ]
}
const benefitsData2 ={
  heading:"Compare <span class='text-primary'>Insurance</span> Plans. Choose What Fits You Best.",
  ...
  paraWidth:"w-[53%]",
  cards:[
  {  classPrefix: "a" ,left:"!left-[10%]",top:"!top-[25%]",color:"bg-[#D9F7C5]", content:"Stay covered without the hassle. Renew your existing policies in just a few taps.",title:"Compare Plans Easily" ,z:"z-[6]", width:"w-[22vw]", height:"17vw" },
  { classPrefix: "b" ,left:"!left-[20%]",top:"!top-[55%]",color:"bg-[#FEFFA7]", content:"Stay covered without the hassle. Renew your existing policies in just a few taps.",title:"Access Policy Details Anytime" ,z:"z-[5]", width:"w-[26vw]", height:"17vw"},
  {  classPrefix: "c",left:"!left-[45.5%]",top:"!top-[15%]",color:"bg-[#FFEAEE]",content:"Stay covered without the hassle. Renew your existing policies in just a few taps.",title:"Quick Renewals" ,z:"z-[7]", width:"w-[18vw]", height:"17vw"},
  {  classPrefix: "d" ,left:"!left-[70%]",top:"!top-[45.9%]",color:"bg-[#CAC5F7]", content:"Stay covered without the hassle. Renew your existing policies in just a few taps.",title:"Flexible Payments",z:"z-[6]", width:"w-[19vw]", height:"17vw"},
  ]
}
const whatWhyData = {
