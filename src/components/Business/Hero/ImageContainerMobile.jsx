...
export const ImageContainerMobile = ({ img1, img2, img3, container }) => {
    ...
    return (
        <>
            ...
            <div ref={mainImgContainer} className="shadow-2xl fadeinanim relative z-10 w-[90%] h-[70vw] rounded-[8vw] overflow-hidden border-[0px] border-black-1 bg-black-1 hidden flex-col justify-between max-sm:flex">
