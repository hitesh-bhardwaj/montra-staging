...
export const BottomContent = ({ img6 }) => {
    return (
        <div className="bg-primary w-screen p-[4vw] flex flex-col gap-[20vw] h-fit absolute bottom-0 text-white max-sm:p-[8vw] max-sm:gap-12 max-sm:static">
            <div className="h-[65vw] hidden max-sm:block mt-12" />
            <div className="w-[42%] self-end text-left space-y-[2vw] max-sm:w-full max-sm:space-y-[6vw]">
                <Heading>
                    <h2 className="text-[3.4vw] font-display font-medium leading-[1.2] max-sm:text-[7.2vw]">
                ...
                <div className="space-y-[2vw] max-sm:space-y-[6vw]">
                    ...
                    <ul className="list-disc space-y-[2vw] pl-5 max-sm:space-y-[6vw]">
                        <Copy>
                    ...
                    <div className="space-y-[1.5vw] w-[78%] max-sm:space-y-[4vw] max-sm:w-full">
                        <div className="fadeupanim shadow-lg rounded-full px-[2vw] py-[1vw] bg-white text-black max-sm:px-[4vw] max-sm:py-[3vw]">
                            Accept cashless payments with ease
                        </div>
                        <div className="fadeupanim shadow-lg rounded-full px-[2vw] py-[1vw] bg-[#FFEAEE] text-black max-sm:px-[4vw] max-sm:py-[3vw]">
                            Access working capital and credit
                        </div>
                        <div className="fadeupanim shadow-lg rounded-full px-[2vw] py-[1vw] bg-[#EAF1FF] text-black max-sm:px-[4vw] max-sm:py-[3vw]">
            ...
            <div className="shadow-2xl fadeinanim relative z-10 w-full h-[70vw] rounded-[8vw] overflow-hidden border-[10px] border-black-1 bg-black-1 hidden flex-col justify-between max-sm:flex">
            ...
            <div className="w-[42%] self-start text-left space-y-[2vw] max-sm:w-full max-sm:space-y-[6vw]">
                <Heading>
                    <h2 className="text-[3.4vw] font-display font-medium leading-[1.2] max-sm:text-[7.2vw]">
                ...
                <div className="space-y-[2vw] max-sm:space-y-[6vw]">
                    ...
                    <div className="space-y-[1.5vw] w-[95%] max-sm:space-y-[4vw] max-sm:w-full">
                        <div className="fadeupanim shadow-lg rounded-full px-[2vw] py-[1vw] bg-white text-black max-sm:px-[4vw] max-sm:py-[3vw]">
