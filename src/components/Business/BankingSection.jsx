...
const data = [
  ...
  },
  {
    ...
    para: "<p>Seamless Payments. Everywhere. Integrate the Montra Payment Gateway into your website or mobile app and let your customers pay their way:</p><ul class='pl-[2vw] space-y-[0.5vw] list-disc'><li>Debit & Credit Cards</li><li>Bank Accounts via QR Scan</li><li>Montra App — with account balance or Installments</li><li>USSD for offline payments</li></ul><p>Fast integration, secure transactions, and more ways to get paid — all with MontraPay.</p>",
