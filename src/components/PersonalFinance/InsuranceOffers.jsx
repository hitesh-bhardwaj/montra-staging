...
const letters = [
    {  classPrefix: "a" ,left:"!left-[10%]",top:"!top-[25%]",color:"bg-[#D9F7C5]", content:"",title:"Compare Plans Easily" ,z:"z-[6]" },
    { classPrefix: "b" ,left:"!left-[15%]",top:"!top-[65%]",color:"bg-[#FEFFA7]", content:"",title:"Access Policy Details Anytime" ,z:"z-[5]"},
    {  classPrefix: "c",left:"!left-[49.5%]",top:"!top-[15%]",color:"bg-[#FFEAEE]",content:"Stay covered without the hassle. Renew your existing policies in just a few taps.",title:"Quick Renewals" ,z:"z-[7]"},
    {  classPrefix: "e" ,left:"!left-[60%]",top:"!top-[80%]",color:"bg-[#CAC5F7]", content:"",title:"Flexible Payments" ,z:"z-[4]" },
  ];
