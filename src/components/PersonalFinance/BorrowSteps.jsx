  ...
  return (
    <section className="w-screen h-screen bg-primary px-[4vw] py-[5%]">
      <div className="w-full h-full flex justify-between text-white">
        <div className="w-[40%]">
          <h2 className="text-[5vw] leading-[1.1] font-display font-medium">Borrow in Minutes</h2>
        </div>
        ...
        <div className="w-[60%] flex flex-col justify-end h-full items-start gap-[10vw] pl-[5vw]">
          <div className="w-full flex flex-col gap-[1vw] h-fit ">
            <h3 className="text-[3.4vw] capitalize font-display"> Choose a Loan Product</h3>
            <p className="w-[70%]">
            Browse the available loan options on Montra and pick one that fits your financial needs.
            </p>
          </div>
