...
export default function Blogs() {
    return (
        <section className="p-[4vw] max-sm:py-[15%] max-sm:px-[7vw]">
            <div className="flex flex-col items-center justify-center max-sm:gap-[8vw] max-sm:items-start">
                ...
                <div className="flex items-start max-sm:flex-col">
                    <div className="w-1/2 grid grid-cols-2 gap-6 max-sm:flex max-sm:flex-col max-sm:w-full">
                        <div className="rounded-[3vw] overflow-hidden bg-white border border-gray hover:bg-primary hover:text-white duration-300 w-full col-span-2 flex justify-between group  max-sm:flex-col max-sm:w-full max-sm:rounded-[5.5vw]">
                        ...
                        <div className="rounded-[3vw] overflow-hidden bg-white border border-gray hover:bg-primary hover:text-white duration-300 w-full col-span-1 flex flex-col justify-between group max-sm:flex-col max-sm:w-full max-sm:rounded-[5.5vw]">
