    ...
    return (
        <section className="p-[4vw] max-sm:py-[15%] max-sm:px-[7vw] bg-[#FBFBFB] relative max-md:py-[7%]">
            <div className="flex flex-col items-center justify-center max-sm:gap-[8vw] max-sm:items-start max-md:gap-[7vw]">
                <Heading>
                    <h2 className="text-[5.7vw] font-display font-medium leading-relaxed mb-[2vw] max-sm:text-[10.5vw] max-md:text-[7.5vw]">Recent Articles</h2>
                </Heading>
                <Copy>
                ...
                <div className="flex items-start max-sm:flex-col max-md:flex-wrap w-full">
                    <div className="w-1/2 grid grid-cols-2 gap-6 max-sm:flex max-sm:flex-col max-sm:w-full max-md:flex max-md:flex-wrap max-md:w-full">
                        <div className={`fadeupanim rounded-[3vw] overflow-hidden bg-white border border-gray hover:bg-primary hover:text-white w-full col-span-2 flex justify-between group max-sm:flex-col max-sm:w-full max-sm:rounded-[5.5vw] transition-colors duration-500 ease-in-out max-md:w-full max-md:flex-col ${active == 0 ? "!bg-primary !text-white" : "bg-white"}`} onMouseEnter={() => {
                            setActive(0)
                        }}>
                            ...
                            <div className="px-[1.5vw] py-[2vw] w-[45%] flex flex-col justify-between max-sm:w-full max-sm:py-[4vw] max-sm:px-[4vw] max-md:w-full max-md:px-[3vw] max-md:py-[4vw]">
                                <div>
                                    <h5 className="mb-[1vw] max-sm:text-[4.5vw] max-sm:mb-[3vw] max-md:text-[3.2vw]">Beyond Faster Payments: A Guide to Complex International Pension Transfers</h5>
                                    <span className="text-[1vw] mb-[4vw] block max-sm:text-[3.4vw] max-md:text-[2.2vw]">19, June 2024</span>
                                </div>
                                <LinkButton text={"Read More"} href="#" className={`text-black-1 group-hover:text-white hover:text-white ${active == 0 ? " !text-white" : ""} `} />
                            </div>
                        </div>

                        <div className={`fadeupanim rounded-[3vw] overflow-hidden bg-white border border-gray hover:bg-primary hover:text-white w-full col-span-1 flex flex-col justify-between group max-sm:flex-col max-sm:w-full max-sm:rounded-[5.5vw] transition-colors duration-500 ease-in-out max-md:w-[44vw] ${active == 1 ? "!bg-primary !text-white" : "bg-white"}`} onMouseEnter={() => {
                            setActive(1)
                        }}>
                            ...
                            <div className="px-[1.5vw] py-[1.5vw] flex flex-col justify-between max-sm:w-full max-sm:py-[4vw] max-sm:px-[4vw] max-md:px-[3vw] max-md:py-[3vw]">
                                <div>
                                    <h5 className="mb-[1vw] max-sm:text-[4.5vw] max-sm:mb-[3vw] max-md:text-[3.2vw]">A Guide to Complex International Pension Transfers</h5>
                                    <span className="text-[1vw] mb-[2vw] block font-display max-sm:text-[3.4vw] max-md:text-[2.2vw]">19, June 2024</span>
                                </div>
                                <LinkButton text={"Read More"} href="#" className={`text-black-1 group-hover:text-white hover:text-white ${active == 1 ? " !text-white" : ""}`} />
                            </div>
                        </div>

                        <div className={`fadeupanim rounded-[3vw] overflow-hidden bg-white border border-gray hover:bg-primary hover:text-white w-full col-span-1 flex flex-col justify-between group max-sm:flex-col max-sm:w-full max-sm:rounded-[5.5vw] transition-colors duration-500 ease-in-out max-md:w-[44vw] ${active == 2 ? "!bg-primary !text-white" : "bg-white"}`} onMouseEnter={() => {
                            setActive(2)
                        }}>
                            ...
                            <div className="px-[1.5vw] py-[1.5vw] flex flex-col justify-between max-sm:w-full max-sm:py-[4vw] max-sm:px-[4vw] max-md:px-[3vw] max-md:py-[3vw]">
                                <div>
                                    <h5 className="mb-[1vw] max-sm:text-[4.5vw] max-sm:mb-[3vw] max-md:text-[3.2vw]">A Guide to Complex International Pension Transfers</h5>
                                    <span className="text-[1vw] mb-[2vw] block max-sm:text-[3.4vw] max-md:text-[2.2vw]">19, June 2024</span>
                                </div>
