            ...
            <div className="flex flex-col items-center justify-center max-sm:gap-[8vw] max-sm:items-start">
                ...
                <div className="flex items-start max-sm:flex-col">
                    <div className="w-1/2 grid grid-cols-2 gap-6 max-sm:flex max-sm:flex-col max-sm:w-full">
                        <div className={`rounded-[3vw] overflow-hidden bg-white border border-gray hover:bg-primary hover:text-white duration-300 w-full col-span-2 flex justify-between group  max-sm:flex-col max-sm:w-full max-sm:rounded-[5.5vw] ${active==0?"!bg-primary !text-white":"bg-white"}`} onMouseEnter={()=>{
                            setActive(0)
                        }}>
                        ...
                        <div className={`rounded-[3vw] overflow-hidden bg-white border border-gray hover:bg-primary hover:text-white duration-300 w-full col-span-1 flex flex-col justify-between group max-sm:flex-col max-sm:w-full max-sm:rounded-[5.5vw] ${active==1?"!bg-primary !text-white":"bg-white"}`} onMouseEnter={()=>{
                            setActive(1)
                        }}>
                        ...
                        <div className={`rounded-[3vw] overflow-hidden bg-white border border-gray hover:bg-primary hover:text-white duration-300 w-full col-span-1 flex flex-col justify-between group max-sm:flex-col max-sm:w-full max-sm:rounded-[5.5vw] ${active==2?"!bg-primary !text-white":"bg-white"}`} onMouseEnter={()=>{
                            setActive(2)
                        }}>
