...
export default function Payments() {
    ...
    // … your existing scroll-driven SVG & color logic here …
    ///     // normalized trigger points for each circle
    const thresholds = {
    ...
    return (
        <section ref={sectionRef} className="h-[600vh]">
            <div className="sticky top-0 px-[4vw] h-screen flex items-center justify-between">
                ...
                {/* Skip Button */}
                <button onClick={handleSkip} className="absolute text-[1vw] bottom-10 right-10 z-30 font-display flex items-center gap-1 duration-200 hover:text-primary">
                    <spna>Skip</spna>
