...
const About = () => {
  return (
    <section
      className="w-screen px-[4vw] py-[5%] h-full bg-[#fbfbfb] max-sm:px-[7vw] overflow-hidden relative max-sm:h-[270vw] max-md:py-[7%]"
      id="about"
    >
      <div className="flex w-full flex-col items-center gap-[5vw] max-sm:items-start max-sm:gap-[7vw]">
        <Heading>
        <h2 className="text-[5.7vw] font-display font-medium w-[55%] leading-[1.3] text-center max-sm:w-[90%] max-sm:text-left max-sm:text-[11vw] max-md:text-[7.5vw] max-md:w-[85%]">
        ...
        <div className="w-[68vw] h-[28vw] relative max-sm:h-[200vw] max-sm:w-[200vw] max-sm:left-[-50%] max-sm:absolute max-sm:top-[22%] max-md:w-[90vw] max-md:h-[50vw] fadeupanim ">
          ...
          <div className="w-full h-full absolute top-0 left-0 flex max-sm:flex-col max-sm:left-[30%]   ">
            ...
            <div className="w-[67%] flex flex-col h-full items-center gap-[2.5vw] pt-[5vw] pl-[3vw] max-sm:w-[40%] max-sm:h-[140vw] max-sm:px-[7vw] max-sm:pt-[20vw] max-sm:gap-[12vw] max-md:pt-[10vw]">
              <div className="w-full h-fit flex flex-col gap-[1vw] max-sm:gap-[4vw]">
                ...
                <p className="text-white w-[70%] pl-[1.5vw] max-sm:w-full max-md:w-full">
