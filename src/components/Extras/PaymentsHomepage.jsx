  ...
  if (globalThis.innerWidth > 1024) {
    useEffect(() => {
      let ctx = gsap.context(() => {
        ...
        const sectionLength = foc_sections.length;
        ...
        sections.forEach((section, i) => {
          const content = section.querySelector('.slides-content');
...
return (
  <>
    <section ref={container} id="use-cases" className={`h-[500vh] bg-white relative ${mode === "personal" ? "h-[500vh]" : "h-[700vh]"} `}>
      <div className="h-screen w-screen sticky top-0 left-0 flex items-center justify-between overflow-hidden">
        {/* Mode Toggle */}
        ...
        {/* Content */}
        <div className="useCases-Container w-[50%] h-full overflow-hidden fadeUp relative ml-[20%]">
          <div className={`useCases-items flex flex-col flex-nowrap`}>
            {/* Use Cases Item 1 */}
            {stepsData[mode].map((item, index) => (
              <div className="useCase-item w-full h-screen flex items-center" id={item.id} key={index}>
                <div className="use_case_content absolute top-0 left-0 h-screen flex items-center mx-auto py-[5vw] px-[3vw]">
