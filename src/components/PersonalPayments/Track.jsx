        ...
        <div className="w-full text-center flex flex-col gap-[2vw] pb-[5%] items-center justify-center">
         ...
         <div className='px-[4vw] py-[4vw] flex items-center justify-between'>
            ...
            <div ref={card2Ref} className='flex flex-col w-[20%] items-start gap-[1.5vw]'>
                ...
                <div className='h-[1px] bg-[#CBCBCB] w-full mt-[3vw] lineDraw'></div>

            </div>
            <div ref={card3Ref} className='flex flex-col w-[20%] items-start gap-[1.5vw]'>
                <Image src={"/assets/images/personal-payments/reward-points.svg"} height={50} width={50} alt='montra-account-statement'/>
            ...
            <div ref={card4Ref} className='flex flex-col w-[20%] items-start gap-[1.5vw]'>
                <Image src={"/assets/images/personal-payments/easy-reward.svg"} height={50} width={50} alt='montra-account-statement'/>
