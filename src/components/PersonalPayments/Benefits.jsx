...
const letters = [
    {  classPrefix: "a" ,left:"!left-[5%]",top:"!top-[25%]",color:"bg-[#EAF1FF]", content:"",title:"Secure from the Start" ,z:"z-[5]" },
    { classPrefix: "b" ,left:"!left-[27%]",top:"!top-[62.9%]",color:"bg-[#CAC5F7]", content:"",title:"Advanced 2FA Protection " ,z:"z-[4]"},
    {  classPrefix: "c",left:"!left-[53%]",top:"!top-[15%]",color:"bg-[#FFEAEE]",content:"",title:"Built-In Payment Checks" ,z:"z-[5]"},
    {  classPrefix: "d" ,left:"!left-[68%]",top:"!top-[45.9%]",color:"bg-[#D9F7C5]", content:"",title:"Your Privacy, Always",z:"z-[4]"},
