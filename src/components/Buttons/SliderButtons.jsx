...
export function PreviousButton({ onClick }) {
  return (
    <button
      ...
      onClick={onClick}
      className="h-[3.5vw] w-[3.5vw] px-[1vw] group rounded-full text-white hover:text-primary relative border border-white hover:border-transparent duration-400 hover:scale-95 cursor-pointer"
    >
