        ...
        <section id="hero" className="w-screen overflow-hidden relative">
            <div className="h-full flex items-center justify-center text-center px-[4vw]">
                <div className="w-[80%] mx-auto space-y-[1.2vw] pt-[14vw] py-[5vw] max-sm:w-full max-sm:pt-[30vw] max-sm:space-y-[7vw]">
                    <h1 className="text-[5.7vw] font-display font-medium capitalize leading-[1.15] heroAnim max-sm:text-[11.5vw] max-sm:leading-[1.2]"><span className="text-primary">Montra: </span>Building future of an Inclusive Financial Ecosystem</h1>
                    <p className="font-body w-[95%] mx-auto heroAnim max-sm:w-[95%]">Montra is reimagining how people and businesses in emerging markets access, manage, and grow their money—without the complexity of traditional banks. We make finance simple, inclusive, and built for real life.</p>
