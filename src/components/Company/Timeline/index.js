...
export default function Timeline() {
    ...
    return (
        <section className="relative w-full h-screen overflow-hidden bg-primary text-white timeline-section" id='timeline'>
            <div className='absolute top-[5%] text-center left-1/2 -translate-x-1/2 w-full max-sm:w-[80%]'>
                <h3 className='leading-[1.2] font-medium font-display text-[5.7vw] max-sm:text-[10.5vw]'>Our Story from Vision to Impact</h3>
            </div>
            <div className='absolute z-[100] bottom-[7%] left-1/2 -translate-x-1/2 flex space-x-[2vw] max-sm:top-[20%] max-sm:bottom-auto max-sm:items-center'>
                <button onClick={prevSlide} className="border w-[3.2vw] h-[3.2vw] flex items-center justify-center border-white hover:bg-white hover:text-primary text-white duration-300 rounded-full max-sm:w-[12vw] max-sm:h-[12vw] " aria-label='previous slide'>
    ...
    return (
        ...
        >
            ...
            >
                ...
                <button onClick={nextSlide} className="border w-[3.2vw] h-[3.2vw] flex items-center justify-center border-white hover:bg-white hover:text-primary text-white duration-300 rounded-full max-sm:w-[12vw] max-sm:h-[12vw]" aria-label='next slide'>
