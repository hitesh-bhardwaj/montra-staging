  ...
  return (
    <>
      <div
        id={id} 
        ref={ref}
        className="card w-[22.5vw] h-[35vw] absolute max-sm:static max-sm:w-[85vw] max-sm:h-[120vw] max-md:w-[43vw] max-md:h-[60vw] max-md:static inner-card-main max-md:mx-auto"
