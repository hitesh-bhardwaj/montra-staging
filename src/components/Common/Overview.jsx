        ...
        <div className="w-full h-full flex items-start justify-between px-[4vw] max-sm:flex-col max-sm:px-[7vw] max-md:flex-col ">
          <div ref={containerRef} className="w-[40%] relative max-sm:w-full fadeupanim max-md:w-full">
            <Image
              ...
              className="object-cover w-full h-[60vw]  z-[2] relative max-sm:h-[180vw] max-sm:left-[-15%] max-md:h-[120vw] max-md:left-[-5%]"
              width={700}
              height={1080}
            />
            <div className="absolute top-[25%] left-[10%] w-full h-full max-sm:left-0 max-md:left-0 max-md:top-[15%]">
              <Image
                ...
                className="w-full h-[35vw] object-cover max-sm:h-[100vw] max-md:h-[80vw] max-md:object-contain"
                width={400}
                height={800}
              />
            </div>
            <div
              ref={block1}
              className="!w-fit  h-fit rounded-[1.2vw] shadow-md drop-shadow-md py-[1vw] px-[1vw] bg-[#F1FFE8] absolute top-[55%] left-[45%] z-[7] flex gap-[1vw] max-sm:px-[5vw] max-sm:gap-[2vw] max-sm:rounded-[3vw] max-sm:py-[3vw] max-sm:top-[70%] max-sm:left-[35%] max-md:px-[3vw] max-md:py-[2vw] max-md:rounded-[3vw] items-center"
            >
