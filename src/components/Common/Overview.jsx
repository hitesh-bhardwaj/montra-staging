...
const Overview = ({ content }) => {
  ...
  return (
    <>
      <section
        className="w-screen h-full bg-[#fbfbfb] overflow-hidden max-sm:pb-[15%]"
        id="overview"
      >
        <div className="w-full h-full flex items-start justify-between px-[4vw] max-sm:flex-col max-sm:px-[7vw] ">
          <div ref={containerRef} className="w-[40%] relative max-sm:w-full fadeupanim">
            <Image
              ...
              className="object-cover w-full h-[60vw]  z-[2] relative max-sm:h-[180vw] max-sm:left-[-15%]"
              width={700}
              height={1080}
            />
            <div className="absolute top-[25%] left-[10%] w-full h-full max-sm:left-0">
              <Image
                ...
                className="w-full h-[35vw] object-cover max-sm:h-[100vw]"
                width={400}
                height={800}
              />
            </div>
            <div
              ref={block1}
              className="!w-fit  h-fit rounded-[1.2vw] shadow-md drop-shadow-md py-[1vw] px-[1vw] bg-[#F1FFE8] absolute top-[55%] left-[45%] z-[7] flex gap-[1vw] max-sm:px-[5vw] max-sm:gap-[2vw] max-sm:rounded-[3vw] max-sm:py-[3vw] max-sm:items-center max-sm:top-[70%] max-sm:left-[35%]"
            >
            ...
            <div
              ref={block2}
              className="w-fit h-fit rounded-[1.2vw] shadow-md drop-shadow-md py-[1vw] px-[1vw] bg-[#FFEAEE] absolute top-[30%] left-[10%] z-[7] flex gap-[1vw] max-sm:px-[5vw] max-sm:gap-[2vw] max-sm:rounded-[3vw] max-sm:py-[3vw] max-sm:items-center max-sm:left-0"
            >
              <div className="w-[2vw] h-[2vw] max-sm:w-[7vw] max-sm:h-[7vw]">
                <Image
                  src={content.icon1}
