      ...
      <div className="w-full h-full flex flex-col gap-[10vw] items-center justify-center max-sm:items-start max-sm:justify-start">
        ...
        <div className="w-full h-full flex flex-col gap-[9vw] items-center">
          {data.content.map((item, index) => (
            <div key={index} className="w-[70%] flex justify-between max-sm:w-full max-sm:flex-col max-sm:gap-[5vw]">
        ...
        <div className={`absolute  left-[28%] w-[0.3px] bg-black/20 ${height} ${data.top} line-div max-sm:hidden`}>
