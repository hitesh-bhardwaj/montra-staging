        ...
        <div className="text-white fixed bottom-0 bg-primary flex flex-col justify-end w-screen h-[50vw] mx-auto pt-[4vw] pb-[1vw] max-sm:w-screen max-sm:pt-[15vw] font-display text-[1.1vw] max-sm:text-lg z-0 max-sm:h-full max-sm:static max-sm:pb-[0vw] max-md:h-[130vw]">
          ...
          <div className="flex flex-row mb-[4vw] justify-between max-sm:flex-col px-[4vw] max-sm:px-[7vw]  max-md:flex-col max-md:gap-[10vw] max-md:px-[7vw]">
            ...
            <div className="w-fit max-sm:w-full max-sm:flex max-sm:flex-col max-sm:justify-center max-sm:items-center max-sm:gap-[7vw] max-md:w-full max-md:justify-center max-md:flex max-md:flex-col max-md:gap-[3vw] ">
              <Image
                className="w-[30vw] max-sm:w-[85%] mb-[2vw]"
                src={logo}
                alt="Montra Logo"
                width={600}
                height={126}
              ...
              <p className="w-[30vw] mb-[1vw] text-[1vw] max-sm:text-lg max-sm:w-full max-sm:text-center max-md:text-[2.5vw] max-md:w-[100%]">
                ...
                financial inclusion in emerging economies - enabling a smooth
                shift from cash to digital payments and making credit more
                accessible for all.
              </p>
              ...
              <div className="flex gap-6 items-end mb-[1vw] max-md:mb-0">
                <Image
                  className="h-[5vw] w-auto aspect-auto max-md:h-[10vw] max-sm:h-[18vw]"
                  width={100}
                  height={100}
                  src={"/assets/images/cbn-logo.svg"}
                  alt="CBN Logo"
                />
                <Image
                  className="h-[3.3vw] w-auto max-md:h-[7vw] max-sm:h-[12vw]"
                  width={100}
                  height={100}
                  src={"/assets/images/ndic-logo.svg"}
                  alt="NDIC Logo"
                />
              </div>
              <p className="text-[1vw] max-sm:text-lg max-md:text-[2.5vw]">
                  ...
                  <div className="space-y-[0.5vw] max-sm:space-y-[2vw] max-sm:mt-[10vw] ">
                    {socialLinks.map((link, index) => (
                      <a
                        ...
                        target="_blank"
                        aria-label="Facebook"
                        className="flex items-center gap-1 group max-sm:gap-3 max-sm:w-fit max-sm:mx-auto"
                      >
          ...
          <div className="px-[4vw] py-4 flex items-center justify-between max-sm:py-[8vw] ">
            <span className="text-[1vw] max-sm:text-[3.8vw] max-md:text-[2vw] ">
              Copyright © Montra 2025
            </span>
            <span className="text-[1vw] max-sm:text-[3.8vw] max-md:text-[2vw]">
              By:{" "}
              <a
                target="_blank"
                className="link-line pb-1"
                href="https://weareenigma.com/"
              >
                <span>Enigma Digital</span>
              </a>
            </span>
          </div>
        </div>
...
const socialLinks = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61553206088663",
  },
  {
    name: "Twitter",
    href: "https://x.com/MontraNige96058",
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/montra-inc/",
  },
  {
    name: "Instagram",
    href: "https://www.instagram.com/montra.ng/",
  },
];
